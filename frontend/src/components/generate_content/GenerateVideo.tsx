                ...
                <div className="grid grid-cols-2 gap-3">
                  {availableAvatars.map((avatar) => (
                    <div
                      ...
                      onClick={() =>
                        setSelectedAvatar(
                          avatar.id === selectedAvatar ? null : avatar.id,
                        )
                      }
                  ...
                  <div className="mt-3 p-2 bg-purple-600/20 border border-purple-500/50 rounded-lg">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-purple-300">
                        {
                          availableAvatars.find((a) => a.id === selectedAvatar)
                            ?.name
                        }{" "}
                        selected
                      </span>
              ...
              {layers.length === 0 && (
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-lg">
                      Upload an image to start building your scene
                    </p>
                ...
                <div className="relative">
                  <div className="h-2 bg-gray-700 rounded-full">
                    <div
                      ...
                      style={{
                        width: `${(currentTime / (cameraMovement.duration * 1000)) * 100}%`,
                      }}
                    />
                  </div>
                  <div className="flex justify-between text-xs text-gray-400 mt-1">
                    <span>0:00</span>
                    <span>
                      {Math.floor(cameraMovement.duration / 60)}:
                      {(cameraMovement.duration % 60)
                        .toString()
                        .padStart(2, "0")}
                    </span>
                  </div>
        ...
        {selectedLayerData && (
          <div className="w-80 bg-gray-800 border-l border-gray-700 p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateLayer(selectedLayerData.id, {
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2">
                  Scale ({selectedLayerData.scale.toFixed(1)})
                </label>
                <input
                  type="range"
                  min="0.1"
